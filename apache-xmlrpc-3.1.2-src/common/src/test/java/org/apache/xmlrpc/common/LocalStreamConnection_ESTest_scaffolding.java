...
public class LocalStreamConnection_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.xmlrpc.common.LocalStreamConnection"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(LocalStreamConnection_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.io.InputStream", false, LocalStreamConnection_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.xmlrpc.common.XmlRpcStreamRequestConfig", false, LocalStreamConnection_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(LocalStreamConnection_ESTest_scaffolding.class.getClassLoader()); 
