...
public class XmlRpcStreamServer_ESTest extends XmlRpcStreamServer_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      doReturn("u[hdwG}3I;r").when(outputStream0).toString();
      xmlRpcLocalStreamServer0.getOutputStream(serverStreamConnection0, xmlRpcStreamRequestConfig1, outputStream0);
      ServerStreamConnection serverStreamConnection1 = mock(ServerStreamConnection.class, new ViolatedAssumptionAnswer());
      int int0 = 162;
      PipedOutputStream pipedOutputStream0 = new PipedOutputStream();
      xmlRpcLocalStreamServer0.getOutputStream(serverStreamConnection1, xmlRpcStreamRequestConfig0, pipedOutputStream0);
      ...
      doReturn(boolean1).when(xmlRpcStreamRequestConfig3).isEnabledForExtensions();
      doReturn(boolean0).when(xmlRpcStreamRequestConfig3).isGzipCompressing();
      int int1 = 1;
      String string0 = "\"n";
      InputStream inputStream0 = mock(InputStream.class, new ViolatedAssumptionAnswer());
      doReturn(int0, int1).when(inputStream0).read();
      ...
      try { 
        xmlRpcLocalStreamServer0.getInputStream(xmlRpcStreamRequestConfig3, serverStreamConnection2);
  ...
  public void test02()  throws Throwable  {
      WebServer webServer0 = new WebServer((-1077));
      XmlRpcServletServer xmlRpcServletServer0 = new XmlRpcServletServer();
      XmlRpcHttpRequestConfigImpl xmlRpcHttpRequestConfigImpl0 = new XmlRpcHttpRequestConfigImpl();
      xmlRpcServletServer0.setMaxThreads((-2113));
      xmlRpcHttpRequestConfigImpl0.setConnectionTimeout((-1077));
      ((XmlRpcStreamServer)xmlRpcServletServer0).isContentLengthRequired(xmlRpcHttpRequestConfigImpl0);
      DefaultXMLWriterFactory defaultXMLWriterFactory0 = new DefaultXMLWriterFactory();
      xmlRpcServletServer0.setXMLWriterFactory(defaultXMLWriterFactory0);
      XmlRpcLocalStreamServer xmlRpcLocalStreamServer0 = new XmlRpcLocalStreamServer();
  ...
  public void test04()  throws Throwable  {
      XmlRpcServletServer xmlRpcServletServer0 = new XmlRpcServletServer();
      XmlRpcServletServer xmlRpcServletServer1 = new XmlRpcServletServer();
      TypeFactoryImpl typeFactoryImpl0 = new TypeFactoryImpl(xmlRpcServletServer1);
      ...
      httpServletResponseWrapper0.encodeRedirectUrl("`qH[J=34:71-W");
      // Undeclared exception!
      try { 
  ...
  public void test09()  throws Throwable  {
      ...
      xmlRpcStreamServer0.logError(throwable0);
      XmlRpcLocalStreamServer xmlRpcLocalStreamServer0 = new XmlRpcLocalStreamServer();
      XmlRpcErrorLogger xmlRpcErrorLogger0 = xmlRpcLocalStreamServer0.getErrorLogger();
      xmlRpcStreamServer0.setErrorLogger(xmlRpcErrorLogger0);
  ...
  public void test12()  throws Throwable  {
      ...
      xmlRpcStreamServer0.convertThrowable((Throwable) null);
      // Undeclared exception!
      try { 
        webServer0.log((Throwable) null);
        fail("Expecting exception: NullPointerException");
         ...
         // no message in exception (getMessage() returned null)
         //
         verifyException("org.apache.xmlrpc.webserver.WebServer", e);
      }
  }
  ...
  public void test22()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IOException");
         ...
         //
         // codegen.java.io.InputStream$MockitoMock$198879184.read() returned value out of range -1..255: 1998
         //
         verifyException("java.util.zip.GZIPInputStream", e);
      }
  }
  ...
  public void test23()  throws Throwable  {
      ...
      InputStream inputStream0 = mock(InputStream.class, new ViolatedAssumptionAnswer());
      doReturn((-1), 0, 0, 0, 0).when(inputStream0).read();
  ...
  public void test34()  throws Throwable  {
      ...
      doReturn(false).when(xmlRpcStreamRequestConfig1).isGzipRequesting();
      OutputStream outputStream0 = mock(OutputStream.class, new ViolatedAssumptionAnswer());
      doReturn("u[hdwG}3I;r", "u[hdwG}3I;r").when(outputStream0).toString();
      ...
      doReturn(false).when(xmlRpcStreamRequestConfig2).isGzipCompressing();
      XmlRpcStreamRequestConfig xmlRpcStreamRequestConfig3 = mock(XmlRpcStreamRequestConfig.class, new ViolatedAssumptionAnswer());
      ...
      InputStream inputStream2 = xmlRpcLocalStreamServer0.getInputStream(xmlRpcStreamRequestConfig2, serverStreamConnection3);
      try { 
        xmlRpcLocalStreamServer0.getRequest(xmlRpcStreamRequestConfig2, inputStream2);
        fail("Expecting exception: Exception");
