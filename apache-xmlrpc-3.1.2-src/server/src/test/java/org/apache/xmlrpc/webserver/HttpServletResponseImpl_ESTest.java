...
public class HttpServletResponseImpl_ESTest extends HttpServletResponseImpl_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      String string0 = "&-2$6e\"x0";
      httpServletResponseImpl0.sendError((-508), "&-2$6e\"x0", "Rl=");
      assertEquals("ISO-8859-1", httpServletResponseImpl0.getCharacterEncoding());
      assertTrue(httpServletResponseImpl0.isCommitted());
      assertEquals(8192, httpServletResponseImpl0.getBufferSize());
      
      String string1 = HttpServletResponseImpl.getStatusMessage(400);
      assertEquals("Bad Request", string1);
  ...
  public void test09()  throws Throwable  {
      ...
      try {
        ...
        fail("Expecting exception: IOException");
         ...
         //
         // Remote address/port is not opened: org.evosuite.runtime.vnet.EndPointInfo@7f6190cd
         //
  ...
  public void test15()  throws Throwable  {
      ...
      assertEquals(8192, httpServletResponseImpl0.getBufferSize());
      assertFalse(httpServletResponseImpl0.isCommitted());
      assertEquals(8192, httpServletResponseImpl1.getBufferSize());
      assertFalse(httpServletResponseImpl1.isCommitted());
      assertEquals("ISO-8859-1", httpServletResponseImpl1.getCharacterEncoding());
      assertNotNull(httpServletResponseImpl1);
      assertFalse(httpServletResponseImpl1.equals((Object)httpServletResponseImpl0));
      
      ServletOutputStream servletOutputStream1 = httpServletResponseImpl1.getOutputStream();
      assertNotSame(httpServletResponseImpl0, httpServletResponseImpl1);
      assertNotSame(servletOutputStream0, servletOutputStream1);
      assertNotSame(httpServletResponseImpl1, httpServletResponseImpl0);
      assertNotSame(servletOutputStream1, servletOutputStream0);
      assertEquals("ISO-8859-1", httpServletResponseImpl0.getCharacterEncoding());
      assertEquals(8192, httpServletResponseImpl0.getBufferSize());
      assertFalse(httpServletResponseImpl0.isCommitted());
      assertEquals(8192, httpServletResponseImpl1.getBufferSize());
      ...
      assertEquals("ISO-8859-1", httpServletResponseImpl1.getCharacterEncoding());
      assertNotNull(servletOutputStream1);
      assertFalse(httpServletResponseImpl0.equals((Object)httpServletResponseImpl1));
      assertFalse(httpServletResponseImpl1.equals((Object)httpServletResponseImpl0));
      assertFalse(servletOutputStream1.equals((Object)servletOutputStream0));
      ...
      assertFalse(httpServletResponseImpl1.isCommitted());
      assertEquals("ISO-8859-1", httpServletResponseImpl1.getCharacterEncoding());
      assertEquals(8192, httpServletResponseImpl2.getBufferSize());
      assertFalse(httpServletResponseImpl2.isCommitted());
      assertEquals("ISO-8859-1", httpServletResponseImpl2.getCharacterEncoding());
      assertNotNull(httpServletResponseImpl2);
      assertFalse(httpServletResponseImpl0.equals((Object)httpServletResponseImpl1));
      assertFalse(servletOutputStream0.equals((Object)servletOutputStream1));
      assertFalse(httpServletResponseImpl1.equals((Object)httpServletResponseImpl0));
      assertFalse(servletOutputStream1.equals((Object)servletOutputStream0));
      assertFalse(httpServletResponseImpl2.equals((Object)httpServletResponseImpl0));
      assertFalse(httpServletResponseImpl2.equals((Object)httpServletResponseImpl1));
      
      httpServletResponseImpl2.setContentType("charset=gb,{k");
      assertNotSame(httpServletResponseImpl0, httpServletResponseImpl2);
      assertNotSame(httpServletResponseImpl0, httpServletResponseImpl1);
      assertNotSame(servletOutputStream0, servletOutputStream1);
      assertNotSame(httpServletResponseImpl1, httpServletResponseImpl0);
      assertNotSame(httpServletResponseImpl1, httpServletResponseImpl2);
      assertNotSame(servletOutputStream1, servletOutputStream0);
      assertNotSame(httpServletResponseImpl2, httpServletResponseImpl0);
      assertNotSame(httpServletResponseImpl2, httpServletResponseImpl1);
      assertEquals("ISO-8859-1", httpServletResponseImpl0.getCharacterEncoding());
      assertEquals(8192, httpServletResponseImpl0.getBufferSize());
      assertFalse(httpServletResponseImpl0.isCommitted());
      assertEquals(8192, httpServletResponseImpl1.getBufferSize());
      ...
      assertEquals("ISO-8859-1", httpServletResponseImpl1.getCharacterEncoding());
      assertEquals(8192, httpServletResponseImpl2.getBufferSize());
      assertEquals("gb,{k", httpServletResponseImpl2.getCharacterEncoding());
      assertFalse(httpServletResponseImpl2.isCommitted());
      assertFalse(httpServletResponseImpl0.equals((Object)httpServletResponseImpl2));
      assertFalse(httpServletResponseImpl0.equals((Object)httpServletResponseImpl1));
      assertFalse(servletOutputStream0.equals((Object)servletOutputStream1));
      assertFalse(httpServletResponseImpl1.equals((Object)httpServletResponseImpl0));
      assertFalse(httpServletResponseImpl1.equals((Object)httpServletResponseImpl2));
      assertFalse(servletOutputStream1.equals((Object)servletOutputStream0));
      assertFalse(httpServletResponseImpl2.equals((Object)httpServletResponseImpl0));
      assertFalse(httpServletResponseImpl2.equals((Object)httpServletResponseImpl1));
  ...
  public void test16()  throws Throwable  {
      ...
      String string1 = "charset=text/htm";
      httpServletResponseImpl0.setIntHeader("charset=text/htm", (-285186159));
      assertFalse(httpServletResponseImpl0.isCommitted());
      assertEquals("ISO-8859-1", httpServletResponseImpl0.getCharacterEncoding());
      assertEquals(8192, httpServletResponseImpl0.getBufferSize());
  ...
  public void test17()  throws Throwable  {
      ...
      int int0 = (-364);
      String string0 = HttpServletResponseImpl.getStatusMessage((-364));
      assertEquals("HTTP Response Status -364", string0);
      assertNotNull(string0);
